...
public class HelloWorldService {
  ...
  /**
   * 服务端通过实现HelloWorldService.Iface接口，向客户端的提供具体的同步业务逻辑。
   */
  ...
  /**
   * 服务端通过实现HelloWorldService.AsyncIface接口，向客户端的提供具体的异步业务逻辑。
   */
  ...
  /**
   * 客户端通过HelloWorldService.Client的实例对象，以同步的方式访问服务端提供的服务方法。
   */
